...
x= 0 # Creating x as a global variable, used to control the infinte loop when disconnect is
pressed
plt.ion() # Tells MATLAB to plot live stream
# Create a File in excel with Headers that describe the telemetry
RESULT = ['Mission_time','Temp1','Redundant Temp1','Pressure1', 'Redundant
Pressure1','Temp2','Redundant Temp2','Pressure2', 'Redundant Pressure2','Temp3','Redundant
Temp3','Pressure3', 'Redundant Pressure3',
'Pressurant_Fill_Indicator','Pressurant_Oxidizer_Indicator','Oxidizer_Fill_Indicator','Oxidizer
_Combustion_Indicator']
...
if __name__ == "__main__":
 ...
 frame_2 = Frame(height = 500, width = 1600, bd = 3, relief = 'groove').place(x = 0, y =
300)
 frame_1 = Frame(height = 400, width = 600, bd = 3, relief = 'groove').place(x = 1000, y =
400)
 #Creating Widgets
...
53
 ...
 # Buttons
 button = Button(root,text = "Send", command = send, width = 6).place(x=1020, y=500) # One
way to send command to Control Sys
 connect = Button(root,text = "Connect", command = connect).place(x=1020, y=420) # connect
to the Control Sys
 disconnect = Button(root,text = "Disconnect", command = disconnect).place(x=1020, y=540) #
Close the program
 # Button Commands for Control System

 button1 = Button(root,text = "Open P-Fill", command = open_Pressurant_fill, width =
12).place(x=1020, y=600)
 button2 = Button(root,text = "Close P-Fill", command = close_Pressurant_fill, width =
12).place(x=1020, y=640)
 button3 = Button(root,text = "Open POIV", command = open_POIV, width = 12).place(x=1020,
y=680)
 button4 = Button(root,text = "Close POIV", command = close_POIV, width = 12).place(x=1020,
y=720)
 button5 = Button(root,text = "Open Oxi-Fill", command = open_Oxidizer_fill, width =
12).place(x=1180, y=600)
 button6 = Button(root,text = "Close Oxi-Fill", command = close_Oxidizer_fill, width =
12).place(x=1180, y=640)
